...
class StudentSchema(Schema):
    ...
    grado = fields.Str(
        required=True,
        validate=[
            validate.OneOf(['1', '2', '3', '4', '5', '6'], error="El grado debe ser entre 1 y 6"),
            SafeString()
        ],
        error_messages={'required': 'El grado es requerido'}
    )
    ...
    turno = fields.Str(
        required=True,
        validate=[
            validate.OneOf(['Mañana', 'Tarde', 'Noche'], error="El turno debe ser Mañana, Tarde o Noche"),
            SafeString()
        ],
